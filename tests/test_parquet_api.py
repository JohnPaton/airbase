...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            ...
            "NO",
            None,
            '{"countries": ["NO"], "cities": [], "properties": ["http://dd.eionet.europa.eu/vocabulary/aq/pollutant/5"], "dataset": 3, "source": "API"}',
            '{"countries": ["NO"], "cities": [], "properties": ["http://dd.eionet.europa.eu/vocabulary/aq/pollutant/5"], "dataset": 2, "source": "API"}',
            '{"countries": ["NO"], "cities": [], "properties": ["http://dd.eionet.europa.eu/vocabulary/aq/pollutant/5"], "dataset": 1, "source": "API"}',
            id="PM10-NO",
        ),
        pytest.param(
            frozenset({"O3"}),
            "IS",
            "Reykjavik",
            '{"countries": ["IS"], "cities": ["Reykjavik"], "properties": ["http://dd.eionet.europa.eu/vocabulary/aq/pollutant/7"], "dataset": 3, "source": "API"}',
            '{"countries": ["IS"], "cities": ["Reykjavik"], "properties": ["http://dd.eionet.europa.eu/vocabulary/aq/pollutant/7"], "dataset": 2, "source": "API"}',
            '{"countries": ["IS"], "cities": ["Reykjavik"], "properties": ["http://dd.eionet.europa.eu/vocabulary/aq/pollutant/7"], "dataset": 1, "source": "API"}',
            id="O3-IS",
        ),
    ),
)
